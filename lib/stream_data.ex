defmodule StreamData do
  ...
  A char is an integer between `0` and `0x10FFFF`.
  ## Examples

      Enum.take(StreamData.char(), 3)
      #=> [177336, 771249, 217041]

  ## Shrinking

  Values generated by this generator shrink like integers, so towards chars
  closer to `0`.
  """
  @spec char() :: t(char())
  def char() do
